...
local servers = orm:create(sql, {
    ...
    entity = {
        ...
        description = { field = "description", type = orm.t.varchar(255) },
        ...
        gamespyPlayers = { field = "gamespy_players", type = orm.t.varchar(32000) },
        ...
        players = { field = "players", type = orm.t.varchar(32000) },
...
local posts = orm:create(sql, {
    ...
    entity = {
        ...
        createdAt = { field="date", type=orm.t.int },
        text = { field="text", type=orm.t.varchar(32000) },
...
local threads = orm:create(sql, {
    ...
    entity = {
        id = { field="id", type=orm.t.int },
        author = { field="author", type=orm.t.int },
        name = { field="name", type=orm.t.varchar(100) },
...
local staticIds = orm:create(sql, {
    ...
    entity = {
        ...
        locale = { field = "lng", type=orm.t.varchar(12) },
